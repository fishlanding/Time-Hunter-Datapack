...
# 死亡不掉落
execute if score GameRuleSet KeepInv matches 1 run setblock 9 153 13 birch_wall_sign[facing=north]{front_text:{messages:['"======"','{"translate": "game.setting.keepinv"}','{"translate": "game.setting.on","color": "green","clickEvent": {"action": "run_command","value": "/function th:setting/onandoff/keepinv_off"}}','"======"']}} destroy
execute if score GameRuleSet KeepInv matches 0 run setblock 9 153 13 birch_wall_sign[facing=north]{front_text:{messages:['"======"','{"translate": "game.setting.keepinv"}','{"translate": "game.setting.off","color": "red","clickEvent": {"action": "run_command","value": "/function th:setting/onandoff/keepinv_on"}}','"======"']}} destroy
# 队伍友伤
execute if score GameRuleSet Friendlyfire matches 0 run setblock 8 153 13 birch_wall_sign[facing=north]{front_text:{messages:['"======"','{"translate": "game.setting.friendfire"}','{"translate": "game.setting.off","color": "red","clickEvent": {"action": "run_command","value": "/function th:setting/onandoff/friendfire_on"}}','"======"']}} destroy
execute if score GameRuleSet Friendlyfire matches 1 run setblock 8 153 13 birch_wall_sign[facing=north]{front_text:{messages:['"======"','{"translate": "game.setting.friendfire"}','{"translate": "game.setting.on","color": "green","clickEvent": {"action": "run_command","value": "/function th:setting/onandoff/friendfire_off"}}','"======"']}} destroy
# 时间扣除模式
