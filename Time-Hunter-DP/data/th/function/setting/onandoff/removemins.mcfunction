...
tellraw @a [{"translate": "game.setting.removetime","color": "dark_purple","bold": true},{"translate": "game.setting.time.changed","color": "white"}," ",{"translate": "game.setting.removemins","color": "green"}]
