...
# 通告
tellraw @a [{"translate": "game.ingame.tishiji","color": "light_purple"},{"translate": "game.ingame.win.title.1","color": "gold"},{"translate": "game.team.blue.name","color": "blue","bold": true},{"translate": "game.ingame.win.title.2","color": "gold"}]
