...
scoreboard players operation @s RemainTime += System DiamondTime

title @s title [{"translate": "game.ingame.rewardtime.title.1"}," ",{"score": {"name": "System","objective": "DiamondTime"}}," ",{"translate": "game.ingame.rewardtime.title.2"}]
